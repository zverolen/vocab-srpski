...
describe('<Tab />', () => {
  ...
  it('Selected correct tab is rendered correctly', () => {
    ...
    cy.get('button')
      .should('have.css', 'background-color', color_reference.black)
      .and('have.css', 'outline', `${color_reference.greenLight} 0px`)
      .and('have.css', 'box-shadow', 'none')
    
    cy.get('button').find('> span')
      .should('have.css', 'box-shadow', `${color_reference.greenLight} 0px 0px 0px 4px`)
      .and('have.css', 'outline', `${color_reference.black} solid 2px`)
  })
  ...
  it.only('Selected wrong tab is rendered correctly', () => {
    ...
    cy.get('button')
      .should('have.css', 'background-color', color_reference.black)
      .and('have.css', 'outline', `${color_reference.redLight} 0px`)
      .and('have.css', 'box-shadow', 'none')
    
    cy.get('button').find('> span')
      .should('have.css', 'box-shadow', `${color_reference.redLight} 0px 0px 0px 4px`)
      .and('have.css', 'outline', `${color_reference.black} solid 2px`)
  })

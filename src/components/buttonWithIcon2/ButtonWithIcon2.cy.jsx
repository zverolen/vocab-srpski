...
describe('<ButtonWithIcon2 />', () => {
  it('Default variant renders correctly in all states', () => {
    // cy.mount(<ButtonWithIcon2 handleClick={() => {}} isOpen={false}/>)
    cy.mount(
      <ButtonWithIcon2 handleClick={() => {}} isDefault={true} type='default-expanded' >
        Инструкция
      </ButtonWithIcon2>
    )
  ...
  it('Expanded menu variant renders correctrly in all states', () => {
    cy.mount(<ButtonWithIcon2 handleClick={() => {}} isOpen={true}/>)
